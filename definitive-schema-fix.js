...
async function definitiveSchemaFix() {
  try {
    console.log('🔧 DEFINITIVE SCHEMA FIX - Ending the back-and-forth cycle...\n');
    ...
    if (incidentError || outreachError) {
      ...
      console.log('💡 Run this script to see exact error details and fix permanently');
    } else {
      console.log('✅ Both forms work - the issue might be intermittent or environment-specific');
    }
