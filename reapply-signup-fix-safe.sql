-- ============================================================================
-- SAFE REAPPLICATION OF SIGNUP FIX
-- ============================================================================
-- This script safely reapplies the signup fix without errors
...
BEGIN
  ...
  -- Create profile (no organization_id column - that's in user_organizations)
  ...
  IF default_org_id IS NOT NULL THEN
    ...
    VALUES (
      NEW.id,
      default_org_id,
      'Responder',  -- Changed from 'member' to match your role constraint
      true
    )
