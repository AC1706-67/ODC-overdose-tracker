...
async function testZipCodeConstraint() {
  try {
    ...
    if (naError) {
      ...
      await supabase.from('incidents').delete().eq('client_id', '00000000-0000-0000-0000-000000000001');
    }
    ...
    if (unknownError) {
      ...
      // Clean up test record
      await supabase.from('incidents').delete().eq('client_id', '00000000-0000-0000-0000-000000000002');
    }
    ...
    if (normalError) {
      ...
      // Clean up test record
      await supabase.from('incidents').delete().eq('client_id', '00000000-0000-0000-0000-000000000003');
    }
