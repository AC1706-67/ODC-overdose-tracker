  ...
  try {
    ...
    if (allOrgs && allOrgs.length > 0) {
      ...
      if (inactiveOrgs.length > 0) {
        console.log('Found inactive organizations, trying to activate the first one...');
      ...
      console.log('You may need to create an organization through the Supabase dashboard or with service role credentials.');
    }
